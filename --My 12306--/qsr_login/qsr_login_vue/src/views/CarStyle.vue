...
<template>
    <div style="padding: 10px"> <!--给表格和其他空一点间隙--->
        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="carNumber" label="列车编号"  />
            <el-table-column prop="carStyle" label="车型类别" />
            <el-table-column prop="carTime" label="列车时间线" />
            <el-table-column prop="carAddress" label="列车行驶路线" />
            ...
            <el-dialog :visible.sync="dialogFormVisible" width="30%" title="提示">
                ...
                <el-form :model="form" label-width="120px">
                    ...
                    <el-form-item label="车型类别">
                        <el-radio v-model="form.carStyle" label="火车">火车</el-radio>
                        <el-radio v-model="form.carStyle" label="高铁">高铁</el-radio>
                        <el-radio v-model="form.carStyle" label="动车">动车</el-radio>
                    </el-form-item>
                    <el-form-item label="列车时间线">
                        <el-input v-model="form.carTime" /> <!--数据库中如下划线nick_name在vue中写成小驼峰形式 不然会报400或500的错--->
                    </el-form-item>
                    <el-form-item label="列车行驶路线">
                        <el-input type="textarea" v-model="form.carAddress" />
                    </el-form-item>
                </el-form>
                <template #footer>
