    ...
    <div>
        ...
        <el-card style="margin:50px 125px">
            ...
            <div class="footer">
                <ul>
                    ...
                    <li>
                        <span style="font-size:18px; margin-left:10px;">待出行订单</span>
                        <span style="color:rgb(245,108,108); margin-left:210px; font-size:18px;">(10)</span>
                        <hr>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <span style="font-size:18px; margin-left:10px;">待发车列车</span>
                        <span style="color:rgb(245,108,108); margin-left:210px; font-size:18px;">(10)</span>
                        <hr>
                    </li>
                    <li>
                        <span style="font-size:18px; margin-left:10px;">正在运行列车</span>
                        <span style="color:rgb(245,108,108); margin-left:210px; font-size:18px;">(10)</span>
                        <hr>
                    </li>
                    <li>
                        <span style="font-size:18px; margin-left:10px;">已完成线路列车</span>
                        <span style="color:rgb(245,108,108); margin-left:175px; font-size:18px;">(10)</span>
                        <hr>
                    </li>
                </ul>
                <ul>
                    ...
                    <li>
                        <span style="font-size:18px; margin-left:10px;">待处理改签订单</span>
                        <span style="color:rgb(245,108,108); margin-left:175px; font-size:18px;">(10)</span>
                        <hr>
                    </li>
                    <li>
        ...
        <el-row :gutter="12" style="margin:50px 125px">
            <el-col :span="12">
                <el-card >
                    <div slot="header">
                        <div class="head">订单总览</div>
                    </div>
                    <div class="footer">
                        <ul>
                            <li>
                                <div style="color:rgb(245,108,108); font-size:25px">1000</div>
                                <div style="padding-top:10px;font-size:20px;">已完成</div>
                            </li>
                            <li>
                                <div style="color:rgb(245,108,108);font-size:25px">1000</div>
                                <div style="padding-top:10px;font-size:20px;">已发售</div>
                            </li>
                            <li>
                                <div style="color:rgb(245,108,108);font-size:25px">500</div>
                                <div style="padding-top:10px;font-size:20px;margin-left:-10px">座位紧张</div>
                            </li>
                            <li>
                                <div style="color:rgb(245,108,108);font-size:25px">5000</div>
                                <div style="padding-top:10px;font-size:20px;margin-left:-10px">全部订单</div>
                            </li>
                        </ul>
                    </div>
                </el-card>
