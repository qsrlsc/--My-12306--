...
<template>
    <div style="padding: 10px"> <!--给表格和其他空一点间隙--->
        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="traller" label="乘客" />
            <el-table-column prop="carNumber" label="车次" />
            <el-table-column prop="sitStyle" label="座位类别" />
            <el-table-column prop="carAddress" label="起点站~终点站" />
            <el-table-column prop="orderStyle" label="订单类别" />
            <el-table-column prop="orderMoney" label="票价" />
            <el-table-column prop="sitNumber" label="座位" />
            ...
            <el-dialog :visible.sync="dialogFormVisible" width="30%" title="提示">
                ...
                <el-form :model="form" label-width="120px">
                    ...
                    <el-form-item label="乘客">
                        <el-input v-model="form.traller" /> <!--数据库中如下划线nick_name在vue中写成小驼峰形式 不然会报400或500的错--->
                    </el-form-item>
                    <el-form-item label="车次">
                        <el-input v-model="form.carNumber" />
                    </el-form-item>
                    <el-form-item label="座位类别">
                        <el-input v-model="form.sitStyle" />
                    </el-form-item>
                    <el-form-item label="起点站~终点站">
                        <el-input v-model="form.carAddress" />
                    </el-form-item>
                    <el-form-item label="订单类别">
                        <el-input v-model="form.orderStyle" />
                    </el-form-item>
                    <el-form-item label="票价">
                        <el-input v-model="form.orderMoney" />
                    </el-form-item>
                    <el-form-item label="座位">
                        <el-input v-model="form.sitNumber" />
                    </el-form-item>
                </el-form>
                <template #footer>
