...
<template>
    <div>
        <div style="margin: 10px 0">
            <el-input style="width: 200px" placeholder="请输入日期" suffix-icon="el-icon-date" class="ml-5" v-model="sdate"></el-input>
            ...
            <el-input style="width: 200px" placeholder="请输入车站编号" suffix-icon="el-icon-message" class="ml-5" v-model="stationId"></el-input>
        ...
        <el-dialog title="列车信息" :visible.sync="dialogFormVisible" width="30%" >
            <el-form label-width="80px" size="small" >
                ...
                <el-form-item label="剩余票数">
                    <el-input v-model="form.leftnum" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
