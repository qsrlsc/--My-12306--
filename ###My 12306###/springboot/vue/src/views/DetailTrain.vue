...
<template>
    <div>
        <div style="margin: 10px 0">
            <el-input style="width: 200px" placeholder="请输入列车详情编号" suffix-icon="el-icon-position" class="ml-5" v-model="dtid"></el-input>
            <el-input style="width: 200px" placeholder="请输入列车编号" suffix-icon="el-icon-message" class="ml-5" v-model="tid"></el-input>
            <el-input style="width: 200px" placeholder="请输入列车类型" suffix-icon="el-icon-search" v-model="ttype"></el-input>
        ...
        <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="dtid" label="列车详情编号" width="100"></el-table-column>
        ...
        <el-dialog title="列车信息" :visible.sync="dialogFormVisible" width="30%" >
            <el-form label-width="80px" size="small" >
                ...
                <el-form-item label="出发时间">
                    <el-date-picker v-model="form.starttime" type="datetime" format="yyyy-MM-dd HH:mm:ss" value-format="yyyy-MM-dd hh:mm:ss"> </el-date-picker>
                </el-form-item>
                <el-form-item label="到达时间">
                    <el-date-picker v-model="form.arrivetime" type="datetime" format="yyyy-MM-dd HH:mm:ss" value-format="yyyy-MM-dd hh:mm:ss"> </el-date-picker>
                </el-form-item>
                <!-- <el-form-item label="到达时间">
...
<script>
    export default {
        ...
        methods: {
            load() {
                this.request.get("/detail-train/page", {
                    params: {
            ...
            save() {
                this.request.post("/detail-train", this.form).then(res => {
                    if (res.code === '200') {
            ...
            del(dtid) {
                this.request.delete("/detail-train/" + dtid).then(res => {
                    if (res.code === '200') {
            ...
            delBatch() {
                let ids = this.multipleSelection.map(v => v.dtid)  // [{}, {}, {}] => [1,2,3]
                this.request.post("/detail-train/del/batch", ids).then(res => {
                    if (res.code === '200') {
            ...
            exp() {
                window.open("http://localhost:9090/detail-train/export")
            },
