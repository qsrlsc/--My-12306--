export function setOption(option: {yAxis: {type: string}; xAxis: {data: [string, string, string, string]; type: string}; legend: {orient: string; left: string}; series: [{data: [], name: string, type: string}, {data: [], name: string, type: string}, {data: [], name: string, type: string}, {data: [], name: string, type: string}]; tooltip: {trigger: string}; title: {subtext: string; left: string; text: string}}) {
